...
<html lang="en">
  ...
  <title>RepData_PeerAssessment1/PA1_template.Rmd at master · awulfes/RepData_PeerAssessment1</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTgzMzk1NTM2OjUzOWUwYzc0ZTg0NjIxNTM3ZWIzYzY5YTQ2OWVlNGM4ZmMwNzMxN2Q4NWU2ZDY0OGM3YmIyMzA1NTgwMTQ2ODY=--685a2bca24a24b7215f205bfe47a58394d05b88e">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="DF58:2B0A6:61A1D59:948FF9F:594FB40C" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="karandeepsc">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="25174955" name="octolytics-dimension-user_id" /><meta content="awulfes" name="octolytics-dimension-user_login" /><meta content="89850377" name="octolytics-dimension-repository_id" /><meta content="awulfes/RepData_PeerAssessment1" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="89850377" name="octolytics-dimension-repository_network_root_id" /><meta content="awulfes/RepData_PeerAssessment1" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/awulfes/RepData_PeerAssessment1/blob/master/PA1_template.Rmd" data-pjax-transient>
...
<div class="header" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/search" class="js-site-search-form" data-scoped-search-url="/awulfes/RepData_PeerAssessment1/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/awulfes/RepData_PeerAssessment1/blob/master/PA1_template.Rmd" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="vjQH4pY3G4CTci9Jo3SrBwC7SYUztYSazr3tfLsKQH8UW4lpq/6K0X5ThFU0R+KWQLao7eofEuY8Sh10uLrnrg==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9Il/FPq/J2A7qzDHtGjNKD84qiTnf0nrVQzqGPfZQhhe5vGfx3a2MdaKm9sjW4S5fzVLTD7V35en+xoQ9GnlyQ==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="OQpHWmXJK5h/GbbPd1/juwLqrWZnMMKAhwNJDO3qTzRrk74h2Hlt8IBvXtfkKVIDo/ayvCoX60taGvH8dchO3w==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="89850377" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="pAHJnLuHf3QcK4GZHzANw6aF6T+G17LVk99pfUfZZ9Wdjpy6gawoUmDM/ynpl4Bev381SfsbUpAbYsUi4f5lfw==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NvAKH/3tA2MFyuVs0OMytwLPJVNjFh8DTHLolF1bM6adGSwf8OWPXmwueqPVP0H3Fv5hIXH9uTU37wbu0isdsw==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="uPMGImX0varwFUjZefYC57887PsyvhszdACI3FdqinGBnfCIyWQuA8gwYIukdDKq4HAgUb5p+IWRPqVetmZVHA==" /></div>
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/awulfes/RepData_PeerAssessment1/blob/480bdb0af0d8c510f025e08710da0ecbd08eccee/PA1_template.Rmd" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:a6f57e4db9a022172b87a2605b0625a3 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/awulfes/RepData_PeerAssessment1/blob/master/PA1_template.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/awulfes/RepData_PeerAssessment1"><span>RepData_PeerAssessment1</span></a></span></span><span class="separator">/</span><strong class="final-path">PA1_template.Rmd</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/awulfes/RepData_PeerAssessment1/commit/480bdb0af0d8c510f025e08710da0ecbd08eccee" data-pjax>
          480bdb0
        </a>
        <relative-time datetime="2017-04-30T13:00:12Z">Apr 30, 2017</relative-time>
      </span>
      <div>
        <img alt="@awulfes" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/25174955?v=3&amp;s=40" width="20" />
        <a href="/awulfes" class="user-mention" rel="author">awulfes</a>
          <a href="/awulfes/RepData_PeerAssessment1/commit/480bdb0af0d8c510f025e08710da0ecbd08eccee" class="message" data-pjax="true" title="Initial commit of result">Initial commit of result</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>3</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="awulfes" href="/awulfes/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=awulfes"><img alt="@awulfes" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/25174955?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Ripley6811" href="/awulfes/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=Ripley6811"><img alt="@Ripley6811" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1886005?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="rdpeng" href="/awulfes/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=rdpeng"><img alt="@rdpeng" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/9612?v=3&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@awulfes" height="24" src="https://avatars0.githubusercontent.com/u/25174955?v=3&amp;s=48" width="24" />
            <a href="/awulfes">awulfes</a>
          </li>
          <li class="facebox-user-list-item">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/awulfes/RepData_PeerAssessment1/raw/master/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/awulfes/RepData_PeerAssessment1/blame/master/PA1_template.Rmd" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/awulfes/RepData_PeerAssessment1/commits/master/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/edit/master/PA1_template.Rmd" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2+eVXxArLaAQ5lZG6Ky9j0vc4x5TXi+dHBQZlD7nWul7QylN1mgYHdz4LVSvUTf85i3FjptYacYfsSvj+83GZg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/awulfes/RepData_PeerAssessment1/delete/master/PA1_template.Rmd" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="7Ri40Xl5b2jxuM8Dokm7eZqt4NUZcDB6MAGdZG91xhwc7tomvaQsomFwYSCKPkhMaFbCt2BhCWmiKjNk4PDW0g==" /></div>
  ...
  <tbody>
  <tr>
  <td><div>Coursera JHU Reproducible Research course - Project Week 1</div></td>
...
<pre lang="{r"><code>unzip(zipfile = "./data/repdata_data_activity.zip", files = "activity.csv", exdir = "./data")
...
<pre lang="{r"><code>stepsPerDay &lt;- aggregate(actNaOmit$steps, list(actNaOmit$date), sum)
...
<pre lang="{r}"><code>mean1 &lt;- mean(stepsPerDay$steps, na.rm = TRUE)
mean1
</code></pre>
<p>Median of number of steps:</p>
<pre lang="{r}"><code>median1 &lt;- median(stepsPerDay$steps, na.rm = TRUE)
median1
</code></pre>
<p>General summary:</p>
<pre lang="{r"><code>summary(stepsPerDay$steps)
...
<pre lang="{r"><code># caluclate avg steps per interval
...
<pre lang="{r"><code>avgInt[which.max(avgInt$AvgNumSteps),]
...
<pre lang="{r"><code>stepsPerDay &lt;- aggregate(imputedData$steps, list(imputedData$date), sum)
colnames(stepsPerDay) &lt;- c("date", "steps")
...
<p>Mean of number of steps:</p>
<pre lang="{r}"><code>mean2 &lt;- mean(stepsPerDay$steps, na.rm = TRUE)
mean2
</code></pre>
<p>Median of number of steps:</p>
<pre lang="{r}"><code>median2 &lt;- median(stepsPerDay$steps, na.rm = TRUE)
median2
</code></pre>
<p>Differences between imputed and orignal data:</p>
<pre lang="{r}"><code>mean1-mean2
median1-median2
...
<pre lang="{r"><code># get day of week
...
<pre lang="{r}"><code>library(lattice)
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.17486s from unicorn-1981933685-wwnhp">GitHub</span>, Inc.</li>
