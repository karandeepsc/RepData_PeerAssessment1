...
<html lang="en">
  ...
  <title>RepData_PeerAssessment1/PA1_template.Rmd at master · sujitdas9960/RepData_PeerAssessment1</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTgzMzk1NTM2OjRjMjU2ZDFkMjM0MGIwMjMwMDM5Yjc0MzNmNmZjOTdkOTNkN2U3ZjA1OTgyYjAxZWY5NDIyYWE2ZWY2OTMyNmM=--df8f5f9f365a27190050c8dd1a303740848c227e">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="E0A8:2B0A6:61AFFFC:94A61EE:594FB612" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="karandeepsc">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="23091419" name="octolytics-dimension-user_id" /><meta content="sujitdas9960" name="octolytics-dimension-user_login" /><meta content="79695571" name="octolytics-dimension-repository_id" /><meta content="sujitdas9960/RepData_PeerAssessment1" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="79695571" name="octolytics-dimension-repository_network_root_id" /><meta content="sujitdas9960/RepData_PeerAssessment1" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/sujitdas9960/RepData_PeerAssessment1/blob/master/PA1_template.Rmd" data-pjax-transient>
...
<div class="header" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/search" class="js-site-search-form" data-scoped-search-url="/sujitdas9960/RepData_PeerAssessment1/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/sujitdas9960/RepData_PeerAssessment1/blob/master/PA1_template.Rmd" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="header-nav-item dropdown js-menu-container">
    ...
    <div class="dropdown-menu-content js-menu-content">
      <div class="dropdown-menu dropdown-menu-sw">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="tu4R1nnF+Qa8YVwrV5IGQUYx7eVF699oUVqRW3gy99ccgZ9dRAxoV1FA9zfAoU/QBjwMjZxBSRSjrWFTe4JQBg==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="vAjI5e7sg0IiySGcKR3VEZFvGK/6cuT7yMIYuF2XPOAWZ0Zu0yUSE8/oioC+LpyA0WL5xyPYcoc6NeiwXiebMQ==" /></div>
      <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
        Sign out
      </button>
</form>  </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="bcdwTjapVLMQcJw2y1oQjxnEi7HEy4ydmdA8A4IawGk/Xok1ixkS2+8GdC5YLKE3uNiUa4nspVZEyYTzGjjBgg==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="79695571" />
  ...
  <li>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Uq2kiqBuGlhLXdop2AHLFzmnx+t5WaOmtbhLVcYDmeyioqYc4bdIOvYGmhoLuLSJT1yaT1txVxWXgB2GWbhwAA==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Z+oZo8vswVHzqG10UhhXy2kTtTHR039nD7RDAA8QW2UY7zeyHyca38hWBLgQfKaEJTUYdicizWtAbRozbycQNA==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="/b/6EuVahOzBK11G3RyIQ2rJ37f5/aw2L68TATn/kjWkK7pCEEUgH1pyxcjuM7zM5rTT2LBHJ9r1oLSiyswgmw==" /></div>
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/sujitdas9960/RepData_PeerAssessment1/blob/643784deb582e7497cc0a57b681de16502a1836c/PA1_template.Rmd" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:881bcc71360937a9fc83b47f0c59bda2 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/sujitdas9960/RepData_PeerAssessment1/blob/master/PA1_template.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/sujitdas9960/RepData_PeerAssessment1"><span>RepData_PeerAssessment1</span></a></span></span><span class="separator">/</span><strong class="final-path">PA1_template.Rmd</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/sujitdas9960/RepData_PeerAssessment1/commit/643784deb582e7497cc0a57b681de16502a1836c" data-pjax>
          643784d
        </a>
        <relative-time datetime="2017-01-22T17:23:48Z">Jan 22, 2017</relative-time>
      </span>
      <div>
        <img alt="@sujitdas9960" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/23091419?v=3&amp;s=40" width="20" />
        <a href="/sujitdas9960" class="user-mention" rel="author">sujitdas9960</a>
          <a href="/sujitdas9960/RepData_PeerAssessment1/commit/643784deb582e7497cc0a57b681de16502a1836c" class="message" data-pjax="true" title="Third commit">Third commit</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>3</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="sujitdas9960" href="/sujitdas9960/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=sujitdas9960"><img alt="@sujitdas9960" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/23091419?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="Ripley6811" href="/sujitdas9960/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=Ripley6811"><img alt="@Ripley6811" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/1886005?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="rdpeng" href="/sujitdas9960/RepData_PeerAssessment1/commits/master/PA1_template.Rmd?author=rdpeng"><img alt="@rdpeng" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/9612?v=3&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@sujitdas9960" height="24" src="https://avatars1.githubusercontent.com/u/23091419?v=3&amp;s=48" width="24" />
            <a href="/sujitdas9960">sujitdas9960</a>
          </li>
          <li class="facebox-user-list-item">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/sujitdas9960/RepData_PeerAssessment1/raw/master/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/sujitdas9960/RepData_PeerAssessment1/blame/master/PA1_template.Rmd" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/sujitdas9960/RepData_PeerAssessment1/commits/master/PA1_template.Rmd" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/edit/master/PA1_template.Rmd" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="fdx2bKsxcEzG2WGLi+d+labSnuKvgHi/lqo01n8wAxYaTiai07uOu+3V4iijQc3gljHmUE5ZkJSoYqRjbUNOvA==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/sujitdas9960/RepData_PeerAssessment1/delete/master/PA1_template.Rmd" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="EESkFiPlaQ4uZL5l391T9eTCMOWzQRWrlWRs3778TAcf9/hxYk1g1hvP5YkdSTTezF11pFkMghKwvucVy2cGbA==" /></div>
...
<pre lang="{r"><code>##Set global options
library(knitr)
...
<pre lang="{r"><code>##Load data from CSV and plot histogram of total steps taken each day
...
<pre lang="{r"><code>##Compute mean and median of total steps taken each day
meanStepsByDay &lt;- mean(stepsByDay$x)
medianStepsByDay &lt;- median(stepsByDay$x)
</code></pre>
<p>Mean number of steps taken each day = <code>r meanStepsByDay</code><br>
Median number of steps taken each day = <code>r medianStepsByDay</code></p>
...
<pre lang="{r"><code>##Compute average 5 min interval steps across all days, its max value and plot
...
maximum number of steps = <code>r max5MinInt</code></p>
...
<pre lang="{r"><code>##Missing value imputed using mean value, averaged across all days, for the
##given interval
...
<p>Total missing or NA count of activities = <code>r missingCount</code><br>
<strong>Missing value imputed using mean value, averaged across all days,
for the given interval</strong><br>
Mean number of steps taken each day after imputing missing values = <code>r meanStepsByDay</code><br>
Median number of steps taken each day after imputing missing values = <code>r medianStepsByDay</code></p>
...
<pre lang="{r"><code>##Plot weekday and weekend steps
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.15155s from unicorn-1981933685-b13fb">GitHub</span>, Inc.</li>
